...
const AI_CAPABILITIES: AiCapability[] = [
  ...
  },
  {
    ...
    prompts: [
      ...
      '找出最近 1 小时日志ERROR最多的服务，对它进行故障定位',
    ],
  },
  {
    id: '3',
    ...
    prompts: [
      '对service-a进行巡检',
      '对service-b进行巡检',
      '对所有服务进行巡检，找出健康度最差的几个汇总生成报告',
      '对service-a以及上下游服务都进行巡检',
    ],
  },
  {
    id: '4',
    ...
    expertId: '',
    prompts: [
      'service-a 最近 1 小时瓶颈在哪里',
      'service-b 最近 1 小时瓶颈在哪里',
      '给我定位下最近5min内的服务报错的根因',
      '给我定位下最近5min内的告警的根因',
    ],
  },
  {
    ...
    prompts: [
      '列出当前所有的进程',
      '找出当前内存占用高的进程',
      '对当前服务打下火焰图，并输出火焰图html',
      '容器 ai-apm-demo 一直重启，帮我 SSH 上去排查并修好',
    ],
  },
  {
    id: '6',
    ...
    expertId: '',
    prompts: [
      '预测下service-a未来一周的请求量趋势图',
      '预测下service-b未来一周的请求量趋势图',
      '预测下mysql未来一周的请求量趋势图',
      '预测下redis未来一周的请求量趋势图',
    ],
  },
